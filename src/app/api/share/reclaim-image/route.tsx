...
export async function GET(request: Request) {
  ...
  try {
    const model = buildShareCardViewModel(parseShareSearchParams(new URL(request.url).searchParams));
    ...
    return new Response(png, { headers: { "Content-Type": "image/png", "Cache-Control": "public, max-age=86400, s-maxage=86400", "X-Content-Type-Options": "nosniff" } });
  } catch (error) {
